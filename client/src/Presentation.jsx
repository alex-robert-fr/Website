...
const App = () => {
  ...
  return (
    <section className="flex flex-col mx-14 mt-10">
      ...
      <div className='-mt-16'>
        ...
        <button className='uppercase bg-indigo-600 text-white font-medium py-2.5 px-5 rounded-full text-sm'>Me contacter</button>
